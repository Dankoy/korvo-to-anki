...
public class TitleCommand {
  ...
  @ShellMethod(key = {"title-count", "tc"}, value = "Count all titles")
  public String count() {
    Long count = titleService.count();
    return objectMapperService.convertToString(count);
  }

  @ShellMethod(key = {"title-get-by-id", "tgbi"}, value = "Get title by id")
  ...
  @ShellMethod(key = {"title-get-all", "tga"}, value = "Get all titles")
  ...
  @ShellMethod(key = {"title-insert", "ti"}, value = "Insert new title")
  ...
  @ShellMethod(key = {"title-delete", "td"}, value = "Delete title by id")
  ...
  @ShellMethod(key = {"title-update", "tu"}, value = "Update title")
  public String update(@ShellOption long id, @ShellOption String authorName,
      @ShellOption long filter) {
